...
def auto():
    canvas = Canvas(Frame_left, bg="Black", width=330, height=290)
    canvas.grid(row=1, column=0)
    # canvas.delete("all")
    image1 = PhotoImage(file="A.png")
    canvas.create_image(150, 145, image=image1)
    canvas.image = image1


def auto1():
    canvas = Canvas(Frame_left, bg="Black", width=330, height=300)
    canvas.grid(row=1, column=0)
    # canvas.delete("all")
    image1 = PhotoImage(file="Logo1.png")
    canvas.create_image(150, 140, image=image1)
    canvas.image = image1
...
def question1():
    ...
    questions = Entry(option3, font=('arial', 20, 'bold'), bg="blue", fg='white', bd=5, width=70,
                      justify=CENTER, textvariable=Question1)
    questions.grid(row=0, column=0, columnspan=12, pady=4)
    optionA = Label(option3, font=('arial', 14, 'bold'), text="A", bg="black", fg='white', bd=5,
                    justify=CENTER)
