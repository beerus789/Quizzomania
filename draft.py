...
questions4 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer4, command=Millionpicture1)
...
def question2():
    ...
    optionB.grid(row=1, column=2, pady=4, sticky=E)
    questions2 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer2, command=Millionpicture2)
    questions2.grid(row=1, column=3, pady=4)
...
def question3():
    Question3.set("Which of these formulae is used to calculate the area of a rectangular agriculture field?")
    ...
    optionC.grid(row=2, column=0, pady=4, sticky=E)
    questions3 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer3, command=Millionpicture3)
    questions3.grid(row=2, column=1, pady=4)
...
def question4():
    ...
    optionB.grid(row=1, column=2, pady=4, sticky=E)
    questions2 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer2, command=Millionpicture4)
    questions2.grid(row=1, column=3, pady=4)
...
def question5():
    ...
    optionA.grid(row=1, column=0, pady=4, sticky=E)
    questions1 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer1, command=Millionpicture5)
    questions1.grid(row=1, column=1, pady=4)
    optionB = Label(option3, font=('arial', 14, 'bold'), text="B", bg="black", fg='white', bd=5, justify=LEFT)
    optionB.grid(row=1, column=2, pady=4, sticky=E)
    questions2 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
...
def question6():
    Question6.set("Which of the following was once a lifeline on the TV show 'Kaun Banega Crorepatii?")
    Answer1.set("Tridev")
    Answer2.set("Triguni")
...
def question7():
    ...
    Answer1.set("Lawn Tennis")
    Answer2.set("Badminton")
    Answer3.set("Table Tennis")
    Answer4.set("Squash")
    Millionpicture6()
    ...
    optionC.grid(row=2, column=0, pady=4, sticky=E)
    questions3 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer3, command=Millionpicture7)
    questions3.grid(row=2, column=1, pady=4)
...
def question9():
    ...
    optionA.grid(row=1, column=0, pady=4, sticky=E)
    questions1 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer1, command=Millionpicture9)
    questions1.grid(row=1, column=1, pady=4)
    optionB = Label(option3, font=('arial', 14, 'bold'), text="B", bg="black", fg='white', bd=5, justify=LEFT)
    optionB.grid(row=1, column=2, pady=4, sticky=E)
    questions2 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
...
def question10():
    ...
    optionA.grid(row=1, column=0, pady=4, sticky=E)
    questions1 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
                        justify=CENTER, textvariable=Answer1, command=Millionpicture10)
    questions1.grid(row=1, column=1, pady=4)
    optionB = Label(option3, font=('arial', 14, 'bold'), text="B", bg="black", fg='white', bd=5, justify=LEFT)
    optionB.grid(row=1, column=2, pady=4, sticky=E)
    questions2 = Button(option3, font=('arial', 14, 'bold'), bg="blue", fg='white', bd=1, width=22, height=2,
